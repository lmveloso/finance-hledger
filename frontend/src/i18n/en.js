...
const dict = {
  ...
  'mes.creditCards.detail.totalDebtTile': 'Total debt',
  'mes.creditCards.detail.debtBreakdown': 'Invoice {invoice} · Committed {committed}',
  'mes.creditCards.detail.installmentsTitle': 'Future installments',
  'mes.creditCards.detail.installmentEndDate': 'ends {date}',
  'mes.creditCards.detail.installmentMonthly': '{amount}/mo',
  ...
  'fluxo.accountDetail.commitmentsTitle': 'Future commitments',
  'fluxo.accountDetail.comprometidoLabel': 'Committed',
  'fluxo.accountDetail.dividaTotalLabel': 'Total debt',
  ...
  // ── PWA banners ────────────────────────────────────────────────────────
  'pwa.update.message': 'A new version is available.',
  'pwa.update.action': 'Reload',
  'pwa.insecure.message':
    'Connection is not secure (http). Offline support and home-screen install are disabled by the browser. Configure HTTPS on the homelab (e.g. `tailscale serve --https=443`) to enable PWA features.',
  'pwa.insecure.dismiss': 'Dismiss',
};
